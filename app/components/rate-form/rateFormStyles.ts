/**
 * Dark glass-panel field styling shared across `RateForm`, the same
 * approach `categoryFormStyles.ts` documents.
 */
export const RATE_FIELD_CLASS =
...
export const RATE_FIELD_ERROR_CLASS =

...
export const Classes = {
  ...
  lime: `bg-[${COLOR.LIME}] text-[${COLOR.DARK_GREEN}] border-3 border-white
                  hover:bg-white hover:text-[${COLOR.DARK_GREEN}] hover:border-[${COLOR.DARK_GREEN}]`,
  brand_blue:
    "bg-brand-blue text-white hover:text-brand-blue border-3 border-brand-blue hover:bg-white transition-all disaPbled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-brand-blue disabled:hover:text-white",

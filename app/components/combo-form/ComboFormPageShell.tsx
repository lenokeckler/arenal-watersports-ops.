...
interface ComboFormPageShellProps {
  children: ReactNode;
  title: string;
}

/**
 * The header-plus-container chrome shared by `/administracion/combos/nueva`
 * and `/administracion/combos/[comboId]` — same shell
 * `CategoryFormPageShell` documents.
 */
const ComboFormPageShell = ({
  children,
  title,
}: ComboFormPageShellProps): JSX.Element => (
...
export default ComboFormPageShell;

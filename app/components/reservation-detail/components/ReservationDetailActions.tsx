...
const ReservationDetailActions = ({
  ...
  <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-white/10 bg-surface-container-lowest/90 pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_20px_rgba(0,0,0,0.4)] backdrop-blur-xl">

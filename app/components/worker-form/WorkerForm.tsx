...
/**
 * `/administracion/trabajadores/nuevo` (US-ADM-001). Presentation only —
 * every decision lives in `useWorkerFormViewModel`.
 */
const WorkerForm = (): JSX.Element => {
  const {
    baseRole,
    createdWorkerId,
    expiresAt,
  ...
  if (createdWorkerId && temporaryPassword) {
    return (
      <WorkerFormSuccess

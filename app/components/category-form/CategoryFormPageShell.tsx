...
interface CategoryFormPageShellProps {
  children: ReactNode;
  title: string;
}

/**
 * The header-plus-container chrome shared by
 * `/administracion/categorias/nueva` and
 * `/administracion/categorias/[categoryId]` — same shell
 * `/administracion/trabajadores/nuevo` inlines, pulled out here because two
 * category pages need it instead of one.
 */
const CategoryFormPageShell = ({
  children,
  title,
}: CategoryFormPageShellProps): JSX.Element => (
...
export default CategoryFormPageShell;

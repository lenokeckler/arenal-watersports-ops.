...
interface UnitFormPageShellProps {
  categoryId: string;
  children: ReactNode;
  title: string;
}
 ...
 */
const UnitFormPageShell = ({
  categoryId,
  children,
  title,
}: UnitFormPageShellProps): JSX.Element => (
  <div className="min-h-screen bg-background px-margin-mobile pb-24 pt-margin-mobile text-on-surface md:px-margin-desktop md:pt-margin-desktop">
    <header className="mx-auto mb-lg flex max-w-form items-center gap-sm">
      <Link
        href={PATHS.ADMIN.UNIT_CATEGORY(categoryId)}
...
export default UnitFormPageShell;

/**
 * Dark glass-panel field styling — same approach `WorkerForm` and
 * `CategoryForm` document (`FIELD_CLASS`) rather than forking `FormField`.
 */
export const UNIT_FIELD_CLASS =
...
export const UNIT_FIELD_ERROR_CLASS =

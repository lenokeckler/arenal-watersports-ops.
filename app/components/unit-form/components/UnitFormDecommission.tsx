  ...
  <div className="flex flex-col gap-sm border-t border-outline-variant/50 pt-sm">
    {isDecommissioned ? (
      ...
      <Button
        ...
        className="flex min-h-12 items-center justify-center gap-2 rounded-lg border border-outline-variant px-md font-button text-button uppercase text-on-surface transition-colors hover:border-error/40 hover:text-error disabled:cursor-not-allowed disabled:opacity-50"
      >
